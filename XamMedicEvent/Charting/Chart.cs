...
namespace XamMedicEvent
{
    ...
    public abstract class Chart
    {
        ...
        public IEnumerable<Charting.Entry> Entries { get; set; }
        ...
        protected void DrawCaptionElements(SKCanvas canvas, int width, int height, List<Charting.Entry> entries, bool isLeft)
        {
